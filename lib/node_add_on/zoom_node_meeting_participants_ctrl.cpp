...
void ZoomNodeMeetingParticipantsCtrlWrap::GetUserInfoByUserID(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	node->Set(context, v8::String::NewFromUtf8(isolate, "isRawLiveStreaming", v8::NewStringType::kInternalized).ToLocalChecked(), v8::Boolean::New(isolate, zn_userInfomation.isRawLiveStreaming));
	node->Set(context, v8::String::NewFromUtf8(isolate, "HasRawLiveStreamPrivilege", v8::NewStringType::kInternalized).ToLocalChecked(), v8::Boolean::New(isolate, zn_userInfomation.HasRawLiveStreamPrivilege));
	...
	node->Set(context, v8::String::NewFromUtf8(isolate, "customerKey", v8::NewStringType::kInternalized).ToLocalChecked(), v8::String::NewFromUtf8(isolate, zs2s(zn_userInfomation.customerKey).c_str(), v8::NewStringType::kInternalized).ToLocalChecked());
#if (defined _WIN32)
