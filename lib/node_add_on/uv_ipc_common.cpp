...
PipeInitParams _g_pipeInitParam;
//////////////////////////////////////////////////////////////////////////
...
#ifndef _WIN32
			if (uv_data.uv_looper)
			{
				uv_data.uv_looper->closing_handles = NULL;
			}
#endif
		}
		else
...
{
	uint64_t readMax = _g_pipeInitParam.maxReadLength + sizeof(VideoRawDataHeader);
	if (nread > readMax)
	{
		return;
	}
