...
void ZMeetingConfigWrap::EnableVideoButtonOnMeetingUI(bool bEnable)
{
    ...
    if (service) {
        ZoomSDKMeetingConfiguration *config = [service getMeetingConfiguration];
        if (config) {
            [config  hideSDKButtons:bEnable ButtonType:VideoButton];
        }
    }
}
...
void ZMeetingConfigWrap::RedirectClickCCBTNEvent(bool bRedirect)
{
    ...
    if (service) {
        ZoomSDKMeetingConfiguration *config = [service getMeetingConfiguration];
        if (config) {
            config.disableToolbarCloseCaptionButtonClickOriginAction = bRedirect;
        }
    }
}
...
void ZMeetingConfigWrap::HideRecordItemOnMeetingUI(bool bHide)
{
    ...
    if (service) {
        ZoomSDKMeetingConfiguration *config = [service getMeetingConfiguration];
        if (config) {
            [config  hideSDKButtons:bHide ButtonType:RecordButton];
        }
    }
}
...
void ZMeetingConfigWrap::RedirectClickEndMeetingBTNEvent(bool bRedirect)
{
    ...
    if (service) {
        ZoomSDKMeetingConfiguration *config = [service getMeetingConfiguration];
        if (config) {
            config.disableToolbarLeaveButtonClickOriginAction = bRedirect;
        }
    }
}
...
void ZMeetingConfigWrap::HideQAOnMeetingUI(bool bHide)
{
    ...
    if (service) {
        ZoomSDKMeetingConfiguration *config = [service getMeetingConfiguration];
        if (config) {
            [config hideSDKButtons:bHide ButtonType:QAButton];
        }
    }
}
void ZMeetingConfigWrap::HidePollOnMeetingUI(bool bHide)
{
    ...
    if (service) {
        ZoomSDKMeetingConfiguration *config = [service getMeetingConfiguration];
        if (config) {
            [config hideSDKButtons:bHide ButtonType:PollingButton];
        }
    }
}
...
void ZMeetingConfigWrap::EnableInviteLinkOnMeetingUI(bool bEnable)
{
    ZoomSDKMeetingService *service = [[ZoomSDK sharedSDK]  getMeetingService];
    if(!service)
        return;
    ...
    if (!config)
        return;
    config.hideInviteLinkOnMeetingUI = !bEnable;
}
//callback
