...
public:
	...
	static void SetPipeServeInitParam(const v8::FunctionCallbackInfo<v8::Value>& args);
...
static void InitClassAttribute<ZoomNodeRawApiCtrlWrap >(const v8::Local<v8::FunctionTemplate>& tpl, v8::Isolate* isolate)
{
	...
	NODE_SET_PROTOTYPE_METHOD(tpl, "SetPipeServeInitParam", ZoomNodeRawApiCtrlWrap::SetPipeServeInitParam);
}
template<>
