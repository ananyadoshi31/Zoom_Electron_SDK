...
NODE_MODULE_INIT(/* exports, module, context */) {
	...
	ZoomNodeSettingShareCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeRawApiCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingAANCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingRawArchivingCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeMeetingLiveStreamCtrlWrap::Init(exports->GetIsolate());
	ZoomNodeRequestRawLiveStreamPrivilegeHandlerWrap::Init(exports->GetIsolate());
...
v8::Persistent<v8::Function> ZoomNodeSettingShareCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeRawApiCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingAANCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingRawArchivingCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeMeetingLiveStreamCtrlWrap::constructor;
v8::Persistent<v8::Function> ZoomNodeRequestRawLiveStreamPrivilegeHandlerWrap::constructor;
///////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
...
//#endif
	...
	do
	{
		...
		if (proto_params.has_strbrandingname())
		{
			zn_initParams.strBrandingName = s2zs(proto_params.strbrandingname());
		}
		...
		if (proto_params.has_customlocalizationfilepath())
		{
			zn_initParams.customLocalizationFilePath = s2zs(proto_params.customlocalizationfilepath());
		}
		if (proto_params.has_usecustomui())
		{
			convertBool(proto_params.usecustomui(), zn_initParams.obConfigOpts.useCustomUI);
		}
...
void ZoomNodeWrap::SetSupportDarkMode(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SetSupportDarkModeParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SetSupportDarkModeParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_support())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}

		bool zn_support = false;
		convertBool(proto_params.support(), zn_support);

		err = _g_native_wrap.SetSupportDarkMode(zn_support);
	} while (false);
...
void ZoomNodeAuthWrap::GenerateSSOLoginWebURL(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
#if (defined _WIN32)
    ZoomSTRING znWebUrl = L"";
#else
    ZoomSTRING znWebUrl = "";
#endif
	do
	{
		com::electron::sdk::proto::GenerateSSOLoginWebURLParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::GenerateSSOLoginWebURLParams >(args, proto_params))
		{
			break;
		}
		if (!proto_params.has_prefixofvanityurl())
		{
			break;
		}
		
		ZoomSTRING znPrefixOfVanityUrl = s2zs(proto_params.prefixofvanityurl());

		znWebUrl = _g_native_wrap.GetAuthServiceWrap().GenerateSSOLoginWebURL(znPrefixOfVanityUrl);
		
	} while (false);
	v8::Local<v8::String> bret = v8::String::NewFromUtf8(isolate, zs2s(znWebUrl).c_str(), v8::NewStringType::kInternalized).ToLocalChecked();
	args.GetReturnValue().Set(bret);
}
void ZoomNodeAuthWrap::SSOLoginWithWebUriProtocol(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SSOLoginWithWebUriProtocolParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SSOLoginWithWebUriProtocolParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_uriprotocol())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		
		ZoomSTRING znUriProtocol = s2zs(proto_params.uriprotocol());

		err = _g_native_wrap.GetAuthServiceWrap().SSOLoginWithWebUriProtocol(znUriProtocol);
	} while (false);
...
void ZoomNodeAuthWrap::GetWebinalLegalNoticesPrompt(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZoomSTRING znPrompt = _g_native_wrap.GetAuthServiceWrap().GetWebinalLegalNoticesPrompt();
	v8::Local<v8::String> bret = v8::String::NewFromUtf8(isolate, zs2s(znPrompt).c_str(), v8::NewStringType::kInternalized).ToLocalChecked();
	args.GetReturnValue().Set(bret);
}
void ZoomNodeAuthWrap::GetWebinalLegalNoticesExplained(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	auto context = isolate->GetCurrentContext();
	ZNWebinarLegalNoticesExplainedInfo zn_explainedInfo;
	zn_explainedInfo = _g_native_wrap.GetAuthServiceWrap().GetWebinalLegalNoticesExplained();
	v8::HandleScope scope(isolate);
	v8::Local<v8::Object> node = v8::Object::New(isolate);
	node->Set(context, v8::String::NewFromUtf8(isolate, "explained_content", v8::NewStringType::kInternalized).ToLocalChecked(), v8::String::NewFromUtf8(isolate, zs2s(zn_explainedInfo.explained_content).c_str(), v8::NewStringType::kInternalized).ToLocalChecked());
	node->Set(context, v8::String::NewFromUtf8(isolate, "url_register_account_owner", v8::NewStringType::kInternalized).ToLocalChecked(), v8::String::NewFromUtf8(isolate, zs2s(zn_explainedInfo.url_register_account_owner).c_str(), v8::NewStringType::kInternalized).ToLocalChecked());
	node->Set(context, v8::String::NewFromUtf8(isolate, "url_register_privacy_policy", v8::NewStringType::kInternalized).ToLocalChecked(), v8::String::NewFromUtf8(isolate, zs2s(zn_explainedInfo.url_register_privacy_policy).c_str(), v8::NewStringType::kInternalized).ToLocalChecked());
	node->Set(context, v8::String::NewFromUtf8(isolate, "url_register_terms", v8::NewStringType::kInternalized).ToLocalChecked(), v8::String::NewFromUtf8(isolate, zs2s(zn_explainedInfo.url_register_terms).c_str(), v8::NewStringType::kInternalized).ToLocalChecked());
...
void ZoomNodeAuthWrap::SetLoginReturnWithReasonCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onLoginReturnWithReason.Empty();
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!args[0]->IsFunction())
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > cb(isolate, cbfunc);
		ZoomNodeSinkHelper::GetInst().onLoginReturnWithReason = cb;
...
void ZoomNodeMeetingWrap::Start(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		startMeetingParam.customer_key = s2zs(proto_params.customerkey());
...
void ZoomNodeMeetingWrap::Start_WithoutLogin(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		startWithoutLoginParam.customer_key = s2zs(proto_params.customerkey());
...
void ZoomNodeMeetingWrap::Join(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		joinMeetingParam.customer_key = s2zs(proto_params.customerkey());
		...
		if (proto_params.has_appprivilegetoken())
		{
			joinMeetingParam.app_privilege_token = s2zs(proto_params.appprivilegetoken());
		}
		if (proto_params.has_join_token())
		{
			joinMeetingParam.join_token = s2zs(proto_params.join_token());
		}
...
void ZoomNodeMeetingWrap::Join_WithoutLogin(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	...
	do
	{
		...
		joinWithoutLoginParam.customer_key = s2zs(proto_params.customerkey());
		...
		if (proto_params.has_appprivilegetoken())
		{
			joinWithoutLoginParam.app_privilege_token = s2zs(proto_params.appprivilegetoken());
		}
		if (proto_params.has_join_token())
		{
			joinWithoutLoginParam.join_token = s2zs(proto_params.join_token());
		}
...
void ZoomNodeMeetingWrap::SetMeetingStatisticsWarningNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingStatisticsWarningNotification.Empty();
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!args[0]->IsFunction()
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > cb(isolate, cbfunc);
		ZoomNodeSinkHelper::GetInst().onMeetingStatisticsWarningNotification = cb;
...
void ZoomNodeMeetingWrap::SetMeetingParameterNotificationCB(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		...
		if (args[0]->IsNull())
		{
			ZoomNodeSinkHelper::GetInst().onMeetingParameterNotification.Empty();
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!args[0]->IsFunction()
		...
		v8::Local<v8::Function> cbfunc = v8::Local<v8::Function>::Cast(args[0]);
		v8::Persistent<v8::Function, v8::CopyablePersistentTraits<v8::Function> > cb(isolate, cbfunc);
		ZoomNodeSinkHelper::GetInst().onMeetingParameterNotification = cb;
...
void ZoomNodeMeetingWrap::GetMeetingAAN(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingAANCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingRawArchivingCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingRawArchivingCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetMeetingLiveStreamCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeMeetingLiveStreamCtrlWrap::NewInstance(args);
}
void ZoomNodeMeetingWrap::GetRequestRawLiveStreamPrivilegeHandler(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeRequestRawLiveStreamPrivilegeHandlerWrap::NewInstance(args);
}
...
void ZoomNodeMeetingUICtrlWrap::SetMeetingTopic(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SetMeetingTopicParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SetMeetingTopicParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_meetingtopic())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		ZoomSTRING _zn_meetingtopic;
		_zn_meetingtopic = s2zs(proto_params.meetingtopic());

		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().SetMeetingTopic(_zn_meetingtopic);
	} while (false);
...
void ZoomNodeMeetingUICtrlWrap::SetCustomizedCloudRecordingMgrUrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SetCustomizedCloudRecordingMgrUrlParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SetCustomizedCloudRecordingMgrUrlParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_crmurl())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		ZoomSTRING _zn_crmurl;
		_zn_crmurl = s2zs(proto_params.crmurl());

		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().SetCustomizedCloudRecordingMgrUrl(_zn_crmurl);
	} while (false);
...
void ZoomNodeMeetingUICtrlWrap::SetCustomizedInvitationDomain(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SetCustomizedInvitationDomainParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SetCustomizedInvitationDomainParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_invitation_domain())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		ZoomSTRING _zn_invitation_domain;
		_zn_invitation_domain = s2zs(proto_params.invitation_domain());

		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().SetCustomizedInvitationDomain(_zn_invitation_domain);
	} while (false);

	v8::Local<v8::Integer> bret = v8::Integer::New(isolate, (int32_t)err);
	args.GetReturnValue().Set(bret);
}
void ZoomNodeMeetingUICtrlWrap::SetCustomizedPollingUrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	v8::Isolate* isolate = args.GetIsolate();
	ZNSDKError err = ZNSDKERR_SUCCESS;
	do
	{
		com::electron::sdk::proto::SetCustomizedPollingUrlParams proto_params;
		if (!SetProtoParam<com::electron::sdk::proto::SetCustomizedPollingUrlParams >(args, proto_params))
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		if (!proto_params.has_pollingurl() ||
			!proto_params.has_bcreate())
		{
			err = ZNSDKERR_INVALID_PARAMETER;
			break;
		}
		ZoomSTRING _zn_pollingURL;
		_zn_pollingURL = s2zs(proto_params.pollingurl());
		bool _zn_bCreate = false;
		convertBool(proto_params.bcreate(), _zn_bCreate);

		err = _g_native_wrap.GetMeetingServiceWrap().GetMeetingUICtrl().SetCustomizedPollingUrl(_zn_pollingURL, _zn_bCreate);
	} while (false);
...
void ZoomNodeSettingWrap::GetSettingShareCtrl(const v8::FunctionCallbackInfo<v8::Value>& args)
{
	ZoomNodeSettingShareCtrlWrap::NewInstance(args);
}
//
