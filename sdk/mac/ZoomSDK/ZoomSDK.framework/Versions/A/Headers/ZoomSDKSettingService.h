...
@protocol ZoomSDKVideoLipSyncAvatarSettingContextDelegate <NSObject>

/**
 * @brief Callback event of notification that the thumbnails of all lip-sync avatar items have been downloaded.
 */
-(void)onLipSyncAvatarItemThumbnailsDownloaded DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSettingDelegate -on3DAvatarItemThumbnailsDownloaded instead");

/**
 * @brief Callback event of notifying that the selected lip-sync avatar item is downloading.
 * @param index The index of the selected lip-sync avatar item.
 */
-(void)onLipSyncAvatarItemDataDownloading:(int)index DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSettingDelegate -on3DAvatarItemDataDownloading: instead");

/**
 * @brief Callback event of notifying that the selected lip-sync avatar item whether has been downloaded successfully.
 * @param bSuccess YES indicates the selected lip-sync avatar item has been downloaded successfully.
 * @param index The index of the selected lip-sync avatar item.
 */
-(void)onLipSyncAvatarItemDataDownloaded:(BOOL)isSuccess index:(int)index DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSettingDelegate -on3DAvatarItemDataDownloaded:index: instead");
@end

@interface ZoomSDKVideoLipSyncAvatarSettingContext: NSObject
{
...
@property(nonatomic, assign)id<ZoomSDKVideoLipSyncAvatarSettingContextDelegate> delegate DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSetting -delegate instead");
 ...
 */
-(BOOL)is3DAvatarSupportedByDevice DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSetting -is3DAvatarSupportedByDevice instead");

/**
 * @brief Determine if the lip-sync avatar feature is enabled.
 * @return YES indicates the lip-sync feature is enabled.
 */
-(BOOL)isLipSyncAvatarEnabled DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSetting -is3DAvatarEnabled instead");
 ...
 */
-(NSArray<ZoomSDK3DAvatarImageInfo*>*)getLipSyncAvatarImageList DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSetting -get3DAvatarImageList instead");
 ...
 */
-(ZoomSDKError)setLipSyncAvatarImage:(ZoomSDK3DAvatarImageInfo*)image DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSetting -set3DAvatarImage: instead");

/**
 * @brief Get the object to preview the lip-sync avatar.
 * @return If the function succeeds, it will return a ZoomSDKVideoLipSyncAvatarPreviewHelper object, otherwise the function fails and returns nil.
 */
- (ZoomSDKVideoLipSyncAvatarPreviewHelper*)getLipSyncAvatarPreviewHelper DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDK3DAvatarSetting -getLipSyncAvatarPreviewHelper instead");
@end
 ...
 */
-(BOOL)isSupportLipSyncAvatar DEPRECATED_MSG_ATTRIBUTE("No longer use");

/**
 * @brief Enable or disable audio-only 3d avatar when the user’s video is off.
 * @param enable YES indicates to show audio-only 3d avatar when the user’smy video is off.
 * @return If the function succeeds, it will return ZoomSDKError_success, otherwise not.
 */
 ...
 */
-(BOOL)isLipSyncAvatarWhenVideoOffEnabled DEPRECATED_MSG_ATTRIBUTE("No longer use");

/**
 * @brief Get the pointer to ZoomSDKVideoLipsyncAvatarSettingContext which is used to set lip-sync avatar.
 * @return If the function succeeds, the return value is the pointer to ZoomSDKVideoLipsyncAvatarSettingContext.Otherwise failed, returns nil.
 */
-(ZoomSDKVideoLipSyncAvatarSettingContext *)getLipSyncAvatarSettingContext DEPRECATED_MSG_ATTRIBUTE("Use ZoomSDKSettingService -get3DAvatarSettings instead");
 ...
 */
- (void)onVideoFilterItemDataDownloaded:(ZoomSDKVideoEffectType)type index:(int)index DEPRECATED_MSG_ATTRIBUTE("Use -onVideoFilterItemThumnailsDownloaded instead");
/**
 * @brief Notify the video fiter item need do some preparing before applied to video.
 */
- (void)onVideoFilterItemDataNeedPrepare:(ZoomSDKVideoEffectType)type index:(int)index DEPRECATED_MSG_ATTRIBUTE("Use -onVideoFilterItemDataDownloading: index: instead");
/**
 ...
 * @param index The index of the video fiter item.
 */
- (void)onVideoFilterItemDataReady:(BOOL)ready type:(ZoomSDKVideoEffectType)type index:(int)index DEPRECATED_MSG_ATTRIBUTE("Use -onVideoFilterItemDataDownloaded: type: index: instead");
@end
 ...
 */
- (NSArray*)getBGImageList DEPRECATED_MSG_ATTRIBUTE("Use -getBGItemList instead");
 ...
 * @return If the function succeeds, it will return ZoomSDKError_Success, otherwise failed.
 */
- (ZoomSDKError)useVideoFilterItem:(ZoomSDKVideoEffectType)type index:(int)index DEPRECATED_MSG_ATTRIBUTE("Use -useVideoFilterItem: instead");
/**
 * @brief Use the specify image as selected face makeup images.
 * @param imageInfo It is video filter object.More detail refer to {@link ZoomSDKVideoFilterItemInfo}
 * @return If the function succeeds, it will return ZoomSDKError_Success, otherwise failed.
 */
...
@property(nonatomic,assign)id<ZoomSDK3DAvatarSettingDelegate> delegate;
...
@property(nonatomic,assign)id<ZoomSDKFaceMakeupSettingContextDelegate> delegate;
 ...
 * @param YES indicates enabled. Othereise not.
 * @return If the function is success will return ZoomSDKError_Success, othereise fail.
 */
 ...
 */
-(NSArray<ZoomSDKFaceMakeupImageInfo *> *)getFaceMakeupImageList;

/**
 * @brief Specify an image to be face makeup image.
 * @param image Specify the image to use. To get extended information,refer to {@ink ZoomSDKFaceMakeupImageInfo}.
 * @return If the function is success will return ZoomSDKError_Success, othereise fail.
 */
 ...
 * @param enable YES indicates enabled. Othereise not.
 * @return If the function is success will return ZoomSDKError_Success, othereise fail.
 */
 ...
 * @param type The specified color is used on which face makeup type. For more details, see {@link ZoomSDKFaceMakeupType}.
 ...
 * @return If the function is success will return ZoomSDKError_Success, othereise fail.
 */
-(ZoomSDKError)setOpactity:(int)opactity type:(ZoomSDKFaceMakeupType)type;
