...
#import "ZoomSDKRawArchivingController.h"
 ...
 */
@property (copy,nonatomic) NSString *meetingTopic;
/**
 ...
 */
@property(nonatomic, copy)NSString *join_token;
@end
 ...
 *@return If the function succeeds, the return value is a pointer to ZoomSDKCustomImmersiveController. Otherwise, the function returns NULL.
 */
 ...
 * @return If the function succeeds, it will return the audio type supported by the current meeting. The value is the 'bitwise OR' of each supported audio type. For more details, see {@link ZoomSDKMeetingSupportAudioType}.
 */
