...
typedef enum{
    ...
    //Put all participants' hands down, available only for the host/co-host DEPRECATED_MSG_ATTRIBUTE(deprecated("Use -lowerAllHands: instead").
    ActionMeetingCmd_LowerAllHands,
    //Adjust the display size fit to the window.
    ActionMeetingCmd_ShareFitWindowMode,
	//Share in original size.DEPRECATED_MSG_ATTRIBUTE(deprecated("Use -switchZoomRatioWhenViewShare: zoomRatio: instead")
...
/**
 * @brief Enumerations of the panelist chat priviledge in webinar meeting.
 */
typedef enum
{
...
/**
 * @brief Enumerations of the type for video subscribe failed reason.
 */
typedef enum{
...
typedef enum
{
    ZoomSDK_LiveTranscription_Status_Stop = 0,   //not start
    ZoomSDK_LiveTranscription_Status_Start = 1,  //start
    ZoomSDK_LiveTranscription_Status_User_Sub = 2, //user subscriber
    ZoomSDK_LiveTranscription_Status_Connecting = 10,     //connecting
...
/**
 * @brief Enumerations of share view zoom ratio.
 */
typedef enum
{
...
typedef enum
{
    ZoomSDK_Chat_Delete_By_None,    // none
    ZoomSDK_Chat_Delete_By_Self,    // delete by self
    ZoomSDK_Chat_Delete_By_Host,    // delete by host
    ZoomSDK_Chat_Delete_By_Dlp,     // delete by dlp when the message goes against the host organization's compliance policies.
}ZoomSDKChatMessageDeleteType;

/**
 * @brief Enumerations of the audio share mode.
 */
typedef enum
{
    ZoomSDKAudioShareMode_Mono,    //Mono
    ZoomSDKAudioShareMode_Stereo,    //Stereo
}ZoomSDKAudioShareMode;

/**
 * @brief Enumerations of waiting room layout type
 */
typedef enum
{
    ZoomSDKWaitingRoomLayoutType_Default,  //Default
    ZoomSDKWaitingRoomLayoutType_Logo,     //Logo
    ZoomSDKWaitingRoomLayoutType_Video,    //Video
}ZoomSDKWaitingRoomLayoutType;

/**
 * @brief Enumerations of waiting room customize data status.
 */
typedef enum
{
    ZoomSDKCustomWaitingRoomDataStatus_Init,          //Init
    ZoomSDKCustomWaitingRoomDataStatus_Downloading,   //Downloading
    ZoomSDKCustomWaitingRoomDataStatus_Download_OK,   //Downloaded
    ZoomSDKCustomWaitingRoomDataStatus_Download_Failed, //Failed to download
}ZoomSDKCustomWaitingRoomDataStatus;

typedef enum
{
    ZoomSDKSignInterpretationStatus_Initial, //The initial status
    ZoomSDKSignInterpretationStatus_Started, //Sign interpretation stared.
    ZoomSDKSignInterpretationStatus_Stopped,  //Sign interpretation stopped.
...
/**
 * @brief Enumerations of the type for meeting supported audio type.
 */
typedef enum
{
